...
const char ssids[] PROGMEM = {
  "Impfdrohne 44\n"
  "Impfdrohne 46\n"
  "Brainwave_Contr?ller 52\n"
  "Brainwave_Controller 21\n"
  "Brainwave_Contr~ller 01\n"
  "tracker04\n"
  "tracker90\n"
  "tracker22\n"
  "RKI Lab 04\n"
  "Biontech Guest WiFi\n"
  "iPhone von Jens Spahn\n"
  "mesh activator 0xf0\n"
  "mesh activator 0x03\n"
  "mesh activator 0x5g\n"
  "mesh activator 0xAS\n"
  "Moderna STAFF\n"
  "GREAT RESET BUTTON\n"
  "Akascha Neutralisator XX\n"
  "Impfchip Basisstation XX\n"
  "5G-Enhancer\n"
  "Vaxx-o-tron 2001\n"
  "RFID NFC SCANNER\n"
  "RFID Impfchip Validator\n"
  "ANTI SHAEF EINHEIT\n"
  "ANTIFA GmbH\n"
  "RKI crowd control test\n"
  "5G Booster\n"
  "Telegram Entschluesselungsdienst\n"
  "Corona Warn App installer\n"
  "mRNA Aerosolvaporisator\n"
  "DARKNET\n"
  "Bundesministerium für Impfzwang\n"
  "iPhone von Kai Enderes\n"
  "Superspreader\n"
  "Anonymous\n"
  "COVID-19 Analysetool\n"
  "COVID-22 Testlauf\n"
  "Biontech Aktivierungscode\n"
};
// ==================== //
